...
namespace h264
{
    ...
    static StdVideoH265VideoParameterSet getStdVideoH265VideoParameterSet(uint32_t fps)
    {
        StdVideoH265VpsFlags vpsFlags = {};
        vpsFlags.vps_timing_info_present_flag = 1u;

        StdVideoH265VideoParameterSet vps = {};
        vps.flags = vpsFlags;
        vps.vps_video_parameter_set_id = 0u;
        vps.vps_num_units_in_tick = 1u;
        vps.vps_time_scale = fps * 2u;

        return vps;
    }

    //static StdVideoH265SequenceParameterSetVui getStdVideoH265SequenceParameterSetVui(uint32_t fps)
    //{
    //    StdVideoH265SpsVuiFlags vuiFlags = {};
    //    vuiFlags.vui_timing_info_present_flag = 1u;

    //    StdVideoH265SequenceParameterSetVui vui = {};
    //    vui.flags = vuiFlags;
    //    vui.vui_num_units_in_tick = 1;
    //    vui.vui_time_scale = fps * 2; // 2 fields

    //    return vui;
    //}

    static StdVideoH265SequenceParameterSet getStdVideoH265SequenceParameterSet(uint32_t width, uint32_t height,
        StdVideoH265SequenceParameterSetVui* pVui)
    {
        StdVideoH265SpsFlags spsFlags = {};
        spsFlags.vui_parameters_present_flag = (pVui == NULL) ? 0u : 1u;
        ...
        sps.sps_video_parameter_set_id = 0u;
    ...
    static StdVideoH265PictureParameterSet getStdVideoH265PictureParameterSet(void)
    {
        StdVideoH265PpsFlags ppsFlags = {};
        //ppsFlags.transform_8x8_mode_flag = 1u;
        ppsFlags.constrained_intra_pred_flag = 0u;
        ppsFlags.deblocking_filter_control_present_flag = 1u;
        ...
        pps.flags = ppsFlags;
        pps.sps_video_parameter_set_id = 0u;
        pps.pps_seq_parameter_set_id = 0u;
        pps.pps_pic_parameter_set_id = 0u;
        pps.num_ref_idx_l0_default_active_minus1 = 0u;
