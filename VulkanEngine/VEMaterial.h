...
namespace ve
{
	...
	struct VETexture : VENamedClass
	{
		...
		vh::VHVideoDecoder::Session* m_videoSession = nullptr; ///<for video textures the linked video session
		...
		VETexture(std::string name, vh::VHVideoDecoder::Session* videoSession);
